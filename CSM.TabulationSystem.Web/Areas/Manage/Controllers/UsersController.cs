...
using BCrypt;
using CSM.TabulationSystem.Web.Areas.Manage.ViewModels.Users;
...
namespace CSM.TabulationSystem.Web.Areas.Manage.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        public IActionResult Invite(CreateUserViewModel model)
        {
            ...
            if (user == null)
            {
                ...
                this.EmailSendNow(
                            ...
                            model.EmailAddress,
                            user.FullName,
                            "Welcome to CSM Bataan GRank System!!!"
                );
                ...
                this.SMSSendNow("Welcome to CSM Bataan GRank System! You have been invited as a " + user.Role.ToString() +". Please use this one-time password : " + password + " to login.", user.PhoneNumber);
            }
        ...
        public IActionResult ResetPassword(Guid? userId)
        {
            ...
            if (user != null)
            {
                ...
                this.EmailSendNow(
                            ...
                            user.EmailAddress,
                            user.FullName,
                            "CSM Bataan GRank System - Password Reset"
                );
        ...
        private string ResetPasswordEmailTemplate(string password, string recepientName)
        {
            return EmailTemplateLayout(@"<tr>
                    ...
                    </tr>", recepientName, "CSM Bataan GRank System - Password Reset");
        }
        ...
        private string WelcomeEmailTemplate(string password, string recepientName, string role)
        {
             return EmailTemplateLayout(@"<tr>
                    ...
                    </tr>", recepientName, "Welcome to CSM Bataan GRank System");
        }
